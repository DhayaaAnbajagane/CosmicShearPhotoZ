#For DR3_1
my_files = { 'deep_catalog_path' : '/project/chihway/dhayaa/DECADE/Imsim_Inputs/deepfield_Y3_allfields.csv', 
...
#For DR3_2
#my_files = { 'deep_catalog_path' : '/project/chihway/dhayaa/DECADE/Imsim_Inputs/deepfield_Y3_allfields.csv', 
#             'wide_catalog_path' : '/project/chihway/data/decade/metacal_gold_combined_20241003.hdf', 
#             'balrog_catalog_path' : '/project/chihway/dhayaa/DECADE/BalrogOfTheDECADE_20241223.hdf5',
#             'redshift_catalog_path' : '/project/chihway/dhayaa/DECADE/Redshift_files/deepfields_raw_with_redshifts_20240723.csv.gz',
#             'tomo_redshift_catalog_path' : '/project/chihway/dhayaa/DECADE/Redshift_files/deepfields_raw_with_redshifts.csv.gz'
#            }
